...
function setup() {
	...
	bob1 = Bodies.circle(360, 400, 35, bob_options)
	World.add(world, bob1)
	bob2 = Bodies.circle(380, 400, 35, bob_options)
	World.add(world, bob2)
	bob3 = Bodies.circle(400, 400, 35, bob_options)
	World.add(world, bob3)
	bob4 = Bodies.circle(420, 400, 35, bob_options)
	World.add(world, bob4)
	bob5 = Bodies.circle(440, 400, 35, bob_options)
